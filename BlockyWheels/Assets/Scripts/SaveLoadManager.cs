...
public static class SaveLoadManager
{
    ...
    public static string lastLevelPlayedString = "LastLevelPlayed";
    ...
    "BestTime08", "BestTime09", "BestTime10", "BestTime11", "BestTime12", "BestTime13", "BestTime14", "BestTime15" };
    public static string lastCheckpointString = "LastCheckpoint";
    public static string lastRotationString = "LastRotation";

    public static string[] carsUnlockedStrings = new string[] { "Empty1", "Jeep", "Micro", "PickUp", "Van", "Limo", "Ambulance", "Firetruck", "Police" };
